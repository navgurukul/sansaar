module.exports = {
  ...
  initialMessageForFacilitator: (facilitatorName) => {
  ...
  initialMessageForStudent: (studentName, lang) => {
    const MessagesForStudents = {
      en: {
        msgtype: 'text',
        body: `Welcome ${studentName} to this batch. It is important that you attend all the classes in this batch. Your peers and facilitator for the batch are in the group. Please do communicate here if you are unable to join the classes.
`,
      },
      hi: {
        msgtype: 'text',
        body: `${studentName} आपका इस batch में स्वागत है | यह important है की आप इस batch की सारी classes में भाग ले | आपके सहपाठी और प्रशिक्षक इस group का हिस्सा है | आप अगर किसी भी वजह से कोई भी class नहीं join कर पाओ, तो आप इस group पर पहले ही inform करें |`,
      },
    };
