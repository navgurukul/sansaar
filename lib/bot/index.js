module.exports = {
  ...
  newClassNotification: {
    msgtype: 'text',
    body:
      'Hi :) There is a new ---TYPE--- on ---TITLE--- scheduled at ---TIME---, on ---DATE--- ---The class will be conducted by ---. To register, you can enroll under the list of upcoming classes.',
  },
