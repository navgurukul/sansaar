module.exports = {
  ...
  getRoomId: (roomName) => {
    const roomAlias = {
      ...
      mch4:
        '!QMcwqEVTyWeSfXpMQF:navguru                                                                                                            kul.org',
  ...
  classDropout: {
    ...
    hi: {
      msgtype: 'text',
      body:
        'Aapke jaane se hume khed hai :( hume bharosa hai ki aap aane wale class me enroll karoge.',
    },
  },
  ...
  CohortChatRoomForStudent: {
    en: {
      msgtype: 'text',
      body:
        'Welcome to this batch. It is important that you attend all the classes in this batch. Your peers and facilitator for the batch are in the group. Please do communicate here if you are unable to join the classes.',
    },
    hi: {
      msgtype: 'text',
      body:
        'आपका इस batch में स्वागत है | यह important है की आप इस batch की सारी classes में भाग ले | आपके सहपाठी और प्रशिक्षक इस group का हिस्सा है | आप अगर किसी भी वजह से कोई भी class नहीं join कर पाओ, तो आप इस group पर पहले ही inform करें |',
    },
  },
  ...
  thankToFacilitator: {
    msgtype: 'text',
    body:
      'Thank you for creating this learning batch. We will add all the students here for smoother coordination. Please do share any feedback with us directly at hi@merakilearn.org in case you face any problems.',
  },
};
