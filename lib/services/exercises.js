...
module.exports = class ExercisesService extends Schmervice.Service {
  ...
  async markExerciseCompleteV2(userId, exerciseId) {
  ...
  async getIdForRemovalV2(userId, exerciseId) {
    const { ExerciseCompletionV2 } = this.server.models();
  ...
  async removeExerciseCompleteV2(id, userId, exerciseId) {
    const { ExerciseCompletionV2 } = this.server.models();
  ...
  async getExerciseCompleteV2(userId) {
    const { ExerciseCompletionV2 } = this.server.models();
