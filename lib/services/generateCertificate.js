    ...
    try {
      ...
      if (pathway_code.toLowerCase() == python_code) {
        ...
        content = fs.readFileSync(
          path.resolve(__dirname, '../../lib/helpers/assets/Meraki certificate - Introduction to Python world.docx'),
          'binary'
        );
      }
        ...
        content = fs.readFileSync(
        path.resolve(__dirname, '../../lib/helpers/assets/Meraki certificate - Introduction to Scratch_New (1).docx'),
        'binary'
        );
        }
      else {
