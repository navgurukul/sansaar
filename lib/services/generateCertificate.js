    ...
    try {
      ...
      if (pathway_code.toLowerCase() == python_code) {
        ...
        content = fs.readFileSync(
          path.resolve(__dirname, '../../lib/helpers/assets/Meraki certificate - Introduction to Python_New.docx'),
          'binary'
        );
      }
        ...
        content = fs.readFileSync(
          path.resolve(__dirname, '../../lib/helpers/assets/Meraki certificate - Introduction to Scratch_New1.docx'),
          'binary'
        );
      }
      else if (pathway_code.toLowerCase() == scrach_code) {
