      ...
      for (const pathway of data) {
        ...
        if (pathwaytopic !== null && pathwaytopic !== undefined && pathwaytopic.length > 0) {
          ...
          if (pathwaytopic[0].course_id !== null && pathwaytopic[0].course_id !== undefined) {
            ...
            module_name = moduleCourseDetails && moduleCourseDetails.data && moduleCourseDetails.data.attributes &&
              moduleCourseDetails.data.attributes.modules && moduleCourseDetails.data.attributes.modules.data[0] && moduleCourseDetails.data.attributes.modules.data[0].attributes.name
          }
