...
module.exports = class C4caService extends Schmervice.Service {
  ...
  createToken = (data) => {
    const JWTtoken = JWT.sign(
      { team_id: data.id, teacher_id: data.teacher_id, flag: data.flag },
  ...
  } // touch  20230920134743_add-col-multiple_choise.js 20231006105337_add_phone_number_in_tcb.js 20231008004713_addPhoneNumberInPartner.js
};
