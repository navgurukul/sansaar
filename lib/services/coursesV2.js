          ...
          _.map(modifiedDataInString, (modifiedCont) => {
            if (modifiedCont.component === 'image') {
              ...
              if (propertiesDataInString.hasOwnProperty(modifiedCont.value)) {
                ...
                .split("<span style=\"color: #eb9371; background-color: rgba(39, 41, 43, 0.83); box-shadow: 2px 2px 2px rgba(22, 9, 1, 0.6); border-radius: 2px; padding: 2px\">")
                .join("<span style=\"background-color: rgba(233, 245, 233, 0.83); border-radius: 2px; padding: 2px\">");
              }
            }
          });
