    ...
    try {
      ...
      if (classes.classes_to_courses !== null) {
        if (classes.course_version === 'v3') {
          ...
          if (!classes.classes_to_courses.slug_id) {
      ...
      classes.forEach((c) => {
        if (c.classes_to_courses !== null) {
          if (c.course_version === 'v3') {
            ...
            if (!c.classes_to_courses.slug_id){
