    ...
    try {
      ...
      if (classes.classes_to_courses !== null) {
        if (classes.course_version === 'v3') {
          ...
          if(classes.classes_to_courses.exercise_v3 == null){
        ...
        classes_to_courses_data =
          course_version === 'v1'
            ...
            : {
                ...
                [!classUpdates.exercise_id ? "slug_id" : "exercise_v3"]: classUpdates.exercise_id || classUpdates.slug_id,
                
              };

        delete classUpdates.pathway_id;
        delete classUpdates.course_id;
        delete classUpdates.slug_id || classUpdates.exercise_id;
      }
