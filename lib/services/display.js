...
module.exports = class DisplayService extends Schmervice.Service {
  ...
  getClassDetails = async (classDetails, userId) => {
    ...
    const extraDetails = {
      rules: {
        en: `<span style=\"font-family:san-serif; font-size:15px;\">1.&nbsp;Join the class atleast\\n10 minutes before schedule.\\n\\n</span><span style=\"font-size:15px;\">2.&nbsp;Watch [this video](https://www.youtube.com/watch?v=QfBnS1Gnw2c) if you are new to\\nMeraki, to follow the instructions.</span>`,
      },
    };
    /* eslint-enable */
