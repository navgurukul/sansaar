  ...
  getNewClassDetails = async (classDetails, userId) => {
    ...
    const classData = {
      ...
      "content": [
        ...
        {
          "type": "paragraph",
          "text": `<b>Teacher</b> - ${classDetails[0].facilitator.name}\n<b>Date and Time</b> - ${dateFormat(classDetails[0].start_time, "dS mmmm, h:MMTT ")}${dateFormat(classDetails[0].end_time, "- h:MMTT (dddd)")}`
        },
        {
          "type": "heading",
        ...
        },
        {
          "type": "ordered_list",
          "contents": [
            `1.Join the class atleast 10 minutes before schedule.\n2. Watch [this video](https://www.youtube.com/watch?v=QfBnS1Gnw2c) if you are new to Meraki, follow the instructions.`,
          ]
        },
        {
          "type": "paragraph",
