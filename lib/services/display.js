...
module.exports = class DisplayService extends Schmervice.Service {
  ...
  pathway = async (pathway, course_type = undefined) => {
    ...
    const data = await Pathways.query()
  ...
  filterClassDetails = async (singleClass, sequence, course_name) => {
    ...
    newExercise.id = singleClass.id;
    newExercise.course_name = course_name;
    newExercise.course_id = singleClass.course_id;
    newExercise.lang = singleClass.lang;
