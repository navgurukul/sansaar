...
module.exports = class AssessmentService extends Schmervice.Service {
  ...
  async fetchSlugsAssessments(id, lang) {
    try {
      ...
      if (solutionObject && solutionObject.type) {
        ...
        assType = { assessment_type: null }; // Set a default value if not found
      }

      const assessment = {
        type: 'assessment', // Assuming this is the type for assessments
        max_selection_count: solutionObject.correct_options_value.length,
