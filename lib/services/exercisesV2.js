...
module.exports = class ExercisesServiceV2 extends Schmervice.Service {
  ...
  async exerciseComplete(user_id = null, slug_id, type = 'exercise', lang = 'en', team_id = null) {
    ...
    try {
      const url = `http://3.110.213.190/api/slugs/${slug_id}?populate[course][populate][pathway][populate]=modules`
      ...
      this.calculateCourseModulePathwayPercent(user_id, course.id, team_id)
