...
module.exports = class ScratchService extends Schmervice.Service {
  async tempCretentialsForAndroid(){
  ...
  async uploadFile(fileObj, userId_scratch, project_name,project_id) {
  ...
  async updateFile(project_id, file, userId_scratch, project_name,projectId) {
    const { Scratch } = this.server.models();
