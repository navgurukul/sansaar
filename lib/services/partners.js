        ...
        if (userRole.length <= 0 || userRole == null || userRole == undefined) {
          if (partnerUser[0].group_id == null && partnerUser[0].space_id === null && partnerUser[0].partner_id === null) {
            ...
            if (partnerUser[0].partner_id) {
              ...
              return [{
                Error: true,
                message: `This student is already associated with ${checkPartnersData[0].name} partner`,code:403,
              ...
              return [{
                Error: true,
                message: `This student is already associated with ${checkPartnerSpace[0].space_name} space`,code:403,
                student_data:studentData
              }];
            }
