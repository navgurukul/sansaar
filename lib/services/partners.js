...
module.exports = class PartnerService extends Schmervice.Service {
  ...
  async meraki_link(partner_id) {
    const { Partner } = this.server.models();
    const merakiLink = `https://play.google.com/store/apps/details?id=org.merakilearn&referrer=utm_source%3Dwhatsapp%26utm_content%3Dpartner_id%253A${partner_id}`;
