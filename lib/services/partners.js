...
module.exports = class PartnerService extends Schmervice.Service {
  ...
  async getPartnerThrowUserID(id) {
    ...
    try {
      ...
      if (!partner.length) {
        return [{ status: 'Error : partner id is not exist' ,code:404},null];
      }
      return [null, partner];
    } catch (err) {
      return [errorHandler(err), null];
  ...
  async createPartner(partner_data) {
    try {
      ...
      return [ { status: 'Partner name is already exist. Try another name!' ,code:404},null];
    } catch (err) {
      return [errorHandler(err), null];
    }
  }
  ...
  async updatePartner(id, updateData) {
    try {
      ...
      if (updatedPartner == undefined) {
        return [{ status: `This partner_id is not exist!`, Partner_id: id,code:404 },null];
      }
  ...
  async deletePartner(id) {
    try {
      ...
      if (!deletedPartner) {
        return [{ status: `Partner_ID is not exist, ${id}.`,code:404 }];
      }
  ...
  async createPartnerNewSpace(partner_id, NewSpace_data) {
    try {
      ...
      if (!existPartner.length) {
        return [
          { status: 'Not found', message: 'partner_id is not exist in the partner table',code:404 },null
        ];
      }
      ...
      return [{ status: 'PartnerSpace name is already exist. Try another name!' ,code:404 },null];
    } catch (err) {
      return [errorHandler(err), null];
    }
  }
  ...
  async getPartnerSpaceByPartnerID(partner_id) {
    try {
      ...
      let existPartner = await Partner.query().where('id', partner_id);
      if (!existPartner.length) {
        return [{ status: 'Not found', message: 'partner_id is not exist.',code:404 },null];
      }
      ...
      return [{ status: "Partner haven't created space." ,code:404 },null];
    } catch (error) {
  ...
  async getPartnerSpaceBySpaceid(space_id) {
    try {
      ...
      return [{ status: `This space_id is not found!`, space_id: space_id ,code:404 },null];
    } catch (err) {
      return [errorHandler(err), null];
    }
  }
  ...
  async deletePartnerSpace(space_id) {
    try {
      ...
      return [{ status: `This space_id is not exist`, space_id: space_id ,code:404 },null];
    } catch (err) {
      return [errorHandler(err), null];
    }
  }
