...
module.exports = class PartnerService extends Schmervice.Service {
  ...
  //     //   return [null,'wow']
  //     //   // return [null, await this.insertData(string_data,partner_id, space_id)];
  //     // } else {
  //     //   return [{ Error: 'this file is invallid', code: 403 }, null];
  //     // }
  //   } catch (err) {
  ...
  // async insertData(array_data, partner_id, group_id){
  //   try{
  //     // total_res = []
  ...
  //             "group_id":group_id
  //           });
  //           logger.info(`update the Email ${data.email}, partneId: ${partner_id}, group_id: ${group_id} `);
  //           console.log(`update the Email ${data.email}, partneId: ${partner_id}, group_id: ${group_id} `);
  ...
  //           });
  //           if (data1) {
  //             logger.info(`Created the Email ${data.email}, partneId: ${partner_id}, group_id: ${group_id} `);
  //             console.log(`Created the Email ${data.email}, partneId: ${partner_id}, group_id: ${group_id} `);
  //           }
  //       }
  //     }
  //   }
