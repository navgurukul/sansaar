...
module.exports = class PartnerService extends Schmervice.Service {
  ...
  //     return [err,null];
  //   }
  //   let Group = await SpaceGroup.query()
  //   .select()
  //   .where({ "id": groupID})

  //   let key__ = `${platform}_link`

  //   if (Group[0][key__] != null || Group[0][key__] != undefined ) {
  //     return [{error: true, "message":`You already created the link`,code: 403},null];
  //   }
  ...
  //     return { error: true, message: 'Something went wrong. Please try again later' };
  //   }
  //   logger.info(`Successfully created new link for ${platform}: `);
  //   let dict ={}
  //   dict[key__]= merakiShortLink.data.link 
