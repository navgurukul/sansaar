...
exports.seed = async function (knex) {
  try {
    ...
    for (const assessmentOutcome of assessmentsOutcomes) {
      ...
      const selected_option = assessmentOutcome.selected_option
        ? `[${assessmentOutcome.selected_option}]`
        : assessmentOutcome.selected_multiple_option;
      ...
      const checkExists = assessmentOutcome.user_id
        ? { slug_id, user_id: assessmentOutcome.user_id }
        : { slug_id, team_id: assessmentOutcome.team_id };
