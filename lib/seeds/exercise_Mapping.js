...
exports.seed = async function (knex) {
  try {
    ...
    const sansaarAssess = await knex('main.learning_track_status')
      .join('main.exercises_v2', 'exercises_v2.id', 'learning_track_status.exercise_id')
    ...
    for (const sansaar of sansaarAssess) {
      ...
      if (strapiMatch) {
        ...
        // console.log(obj);
        // eslint-disable-next-line no-await-in-loop
        await knex('main.learning_track_status_outcome').insert(obj);
      }
    }
