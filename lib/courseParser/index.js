...
class CoursesSeeder {
  constructor(parseSingleCourse, courseFolderName, ifUpdateDB) {
  ...
  static getCourseFolderName() {
    // getting folder name
    if (process.argv.indexOf('--parseSingleCourse') > -1 && process.argv.indexOf('--json') > -1) {
...
if (!module.parent) {
  ...
  const seeder = new CoursesSeeder(parseSingleCourse, courseFolderName, ifUpdateDB);
