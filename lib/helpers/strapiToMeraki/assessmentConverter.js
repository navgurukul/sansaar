...
function options(dynamic) {
  ...
  if (correctValues.length > 0) {
    ...
    correct = [{ "value": 1 }]; // In case of true is not selected in content
  }
  incorrect = incorrectValues;
...
function explaination(explanation) {
  ...
  const InCorrectHeaderBlock = [
    {
      value: `😟 <span style="color: red;">Missed the bull's eye</span>`,
      variant: 3,
      component: 'header',
    },
    {
  ...
  const partiallyCorrectHeaderBlock = [
    {
      value: `😟 <span style="color: red;">So close...It's partially correct but there are more correct options</span>`,
      variant: 3,
      component: 'header',
    },
    {
  ...
  const partiallyIncorrectHeaderBlock = [
    {
      value: `😟 <span style="color: red;">So close...It's partially correct but with incorrect options</span>`,
      variant: 3,
      component: 'header',
    },
    {
...
const assessmentConverter = (attributes) => {
  ...
  const finalData = [
    ...questionData,
    optionsData,
    { type: optionType, correct_options_value: correct, incorrect_options_value: incorrect, component: 'solution' },
    explanationData,
  ];
