  ...
  if (codeBlock) {
    questionData.push({
      ...
      value: codeBlock.data.code
        .replace(/ {4}/g, '&emsp;&emsp;')    // Replace 4 spaces with 2 &emsp; entities
        .replace(/ {8}/g, '&emsp;&emsp;&emsp;&emsp;')    // Replace 8 spaces with 4 &emsp; entities
        .replace(/ {16}/g, '&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;')  // Replace 16 spaces with 8 &emsp; entities
        .replace(/\n/g, '<br>'),
    });
  }
  if (image) {
