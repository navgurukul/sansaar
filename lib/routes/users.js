...
module.exports = [
...

  {
    ...
    options: {
      description:
        'Genereate auth URL for user to get consent for calendar and youtube permissions.for youtube and calendar you need to choose both',
      tags: ['api'],
      auth: {
        strategy: 'jwt',
      },
      ...
      handler: async (request) => {
        ...
        const authURL = await calendarService.generateAuthUrl(id, email, request.query.choose);
        // eslint-disable-next-line
  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request, h) => {
        ...
        const [errpathwayIDBy, pathwayCourses] =
        ...
        const [err, coursePerformance] = await pathwayServiceV2.resultScorePathwayCourses(
