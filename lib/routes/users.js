...
module.exports = [
  ...
  },
  {
    ...
    path: '/users/tokens',
    options: {
      description: 'Save user access token and refresh token for calendar after successful user consent for calendar event permissions.',
      tags: ['api'],
      auth: {
        strategy: 'jwt',
      },
      ...
      handler: async (request, h) => {
        ...
        // console.log(CONFIG.auth.googleClientIDWeb, CONFIG.auth.googleClientSecretWeb);
