  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request) => {
        ...
        const user = await userService.loginWithGoogle(request.payload);
        const token = await userService.createToken(user);
  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request) => {
        ...
        await userService.updateUserName(request.auth.credentials.id, request.payload.name);
