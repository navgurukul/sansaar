...
module.exports = [
  ...
  },
  {
    ...
    options: {
      description: 'Get students data and class activities (by partner ID)',
      tags: ['api'],
      auth: {
        strategy: 'jwt',
        scope: ['admin'],
      ...
      handler: async (request, h) => {
        ...
        logger.info(
          `id- ${request.auth.credentials} Get a partner students data and class activities (by partner ID)`
        );
