...
module.exports = [
  {
    ...
    options: {
      ...
      handler: async (request) => {
        ...
        const matrixCredentials = await displayService.createMatrixCredentials(user.name);
        const { room_id, ...matrixWithoutRoomId } = matrixCredentials;
        user = { ...user, ...matrixWithoutRoomId };
