  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request, h) => {
        ...
        let check = true;
        // eslint-disable-next-line
        for (const singleVolunteer of volunteerUserId) {
          const pathways_id = singleVolunteer.pathway_id;
          if (singleVolunteer.user_id !== null && singleVolunteer.user_id !== undefined) {
            check = false;
