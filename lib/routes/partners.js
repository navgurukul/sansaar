    ...
    options: {
      ...
      handler: async (request, h) => {
        ...
        if (partnerId == null) {
          return {
            error: true,
            message: `Hey ${request.auth.credentials.name} you're partner_id is null, if you want to add an user then please login with partner specific link. Note:- you are able to see partner dashboard coz you have an admin access as well.`,
          };
        }
        try {
