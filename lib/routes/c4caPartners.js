   ...
   // Facilitator
   {
    ...
    options: {
        ...
        handler: async (request, h) => {
          ...
          const [err1, data] = await c4caPartnerService.c4caTeacherInviteLink(request.payload.c4ca_partner_id,resp['data']['id']);
          let finalData = c4caService.responseWrapper(data, "success");
          const message = 'Facilitator created successfully!';
          return { message,...finalData };
