...
const PathwayCoursesV2 = require('../models/pathwayCourses');
...
module.exports = [
  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request, h) => {
        ...
        const [errInPathway, pathwayCourses] = await displayService.getPathwayCoursesV2(pathway.id);
  ...
  },
  {
    ...
    options: {
      ...
      validate: {
        params: Joi.object({
          pathwayId: PathwayCoursesV2.field('pathway_id'),
        }),
        payload: Joi.object({
          courseIds: Joi.array().items(PathwayCoursesV2.field('course_id')),
        }),
      },
      handler: async (request, h) => {
        const { pathwayServiceV2, displayService } = request.services();
  ...
  },
  {
    ...
    options: {
      ...
      validate: {
        params: Joi.object({
          pathwayId: PathwayCompletionV2.field('pathway_id'),
        }),
      },
      handler: async (request, h) => {
        const { pathwayServiceV2 } = request.services();
