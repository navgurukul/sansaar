...
module.exports = [
  {
    ...
    options: {
      ...
      handler: async (request, h) => {
        const { displayService, mentorshipService, userService, pathwayService } = request.services();
    ...
    options: {
      ...
      handler: async (request, h) => {
        ...
        const addAndFetchMentees = async (txn) => {
          ...
          return await mentorshipService.getMentees(pathwayId, userId, txn)
        }
  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request, h) => {
        const { displayService, mentorshipService, pathwayService } = request.services();
