...
module.exports = [
  {
    ...
    options: {
      ...
      handler: async (request, h) => {
        ...
        // ----- getting all classes data starting from given date ( startDate ) -----
    ...
    options: {
      ...
      handler: async (request, h) => {
        ...
        if (payload.frequency && payload.pathway_id !== null && payload.pathway_id !== undefined) {
          // ----------data takes from pathways_v2 table through id-------------------------
  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request, h) => {
        const { classesService, displayService } = request.services();
        const { classId } = request.params;
        //-----------data is comes from classes table through their id-----------------------
