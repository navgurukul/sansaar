...
const { createCalendarEvent } = require('../helpers/bot/calendar');
  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request) => {
        ...
        if (calendarEvent !== ('event_creation_error' || undefined)) {
        ...
        throw Boom.badRequest(
          'Some error occured in creating a class event. A class might already be scheduled during this time span.'
        );
      },
    },
  },
