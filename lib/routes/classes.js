...
const classAmazonCoding = require('../helpers/classesInfo/pythonClassInfo.json')
      ...
      handler: async (request, h) => {
        ...
        if (recurringEvents.length > 0) {
          ...
          if (
            ...
            if(pathwayDetails.code === 'ACB') {
              recurringPayload.forEach((e, index) => {
                e.sub_title = classAmazonCoding[index].subTitle;
                e.description = classAmazonCoding[index].description;
              });
            }
          }
