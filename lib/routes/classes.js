      ...
      handler: async (request, h) => {
        ...
        if (request.headers['delete-all'] && classToDelete.parent_class) {
          const deleteClasses = async () => {
            ...
            logger.info(`Classes with class id - ${request.params.classId} deleted by user - ${request.auth.credentials}`);
            return deletedClasses;
          };
        ...
        const deleteAClass = async () => {
          ...
          logger.info(`Class with class id - ${request.params.classId} deleted by id- ${request.auth.credentials}`);
          return deletedClass;
        };
