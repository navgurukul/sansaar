        ...
        options: {
            ...
            validate: {
                payload: Joi.object({
                    ...
                    c4ca_partner_id: Joi.number().integer().optional(),
            ...
            handler: async (request, h) => {
                ...
                let { c4ca_partner_id } = request.payload.credentials; // activate this line when partner url get fix
                c4ca_partner_id = c4ca_partner_id ||  1 ; // and remove this line 
                if (c4ca_partner_id !== null && c4ca_partner_id !== undefined) {
                    const [err, resp] = await c4caService.setTeacherProfile(profile_url, request.payload, user_id, c4ca_partner_id);
                    if (err) {
...

    {
        ...
        options: {
            ...
            handler: async (request, h) => {
                ...
                const module_id = request.params.module_id
