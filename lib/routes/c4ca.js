...
module.exports = [
    {
        ...
        options: {
            ...
            handler: async (request, h) => {
                ...
                let profile_url = request.payload.profile_url;
                delete request.payload.profile_url;
                const [err, resp] = await c4caService.setTeacherProfile(profile_url,request.payload, user_id);
                if (err) {
