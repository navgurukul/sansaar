    ...
    options: {
      ...
      handler: async (request, h) => {
        ...
        for (const courseId of courseIds) {
          ...
          result.push(h.context.transaction(deleteACourse));
        }
        return result;
      },
    },
...

  {
    ...
    options: {
      ...
      handler: async (request, h) => {
        ...
        const result = [];
        for (const course of courses) {
          const { id: courseId, ...payload } = course;
          console.log(courseId, payload);
