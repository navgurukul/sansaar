...
module.exports = [
    ...
    options: {
      ...
      handler: async (request, h) => {
        ...
        try {
          ...
          const [errTotalUsersID, userIDs, infoUser] =
          ...
          const [errpathwayIDBy, pathwayCourses, assessmentIds] =
          ...
          const [err, DataLoader] = await teacherService.DataLoaderSheetOBJ(
            infoUser,
            results,
            assessmentIds
          );
  ...
  {
    method: 'GET',
    path: '/Update/dataIntoSheetNew/{pathway_id}',
    options: {
      description: 'Storing the data into the sheet',
      tags: ['api'],
      validate: {
      ...
      handler: async (request, h) => {
        ...
        try {
          ...
          const [errpathwayIDBy, pathwayCourses, total_assessmentIds] =
