...
module.exports = [
  ...
  {
    method: 'GET',
    path: '/Update/teachers_progress',
    options: {
      description: 'Get the 1359_mcdigital_teachers_progress.csv file',
      tags: ['api'],
      auth: {
        strategy: 'jwt',
        scope: ['admin', 'partner'],
  ...
  {
    method: 'GET',
    path: '/Update/teachers/weekly/last-login',
    options: {
  ...
  {
    method: 'GET',
    path: '/Update/teachers/weekly/last-login/report',
    options: {
