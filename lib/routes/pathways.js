...
schemas.pathway = Joi.object({
  ...
  tracking_frequency: Pathway.field('tracking_frequency').optional(),
  tracking_day_of_week: Pathway.field('tracking_day_of_week').optional(),
  tracking_days_lock_before_cycle: Pathway.field('tracking_days_lock_before_cycle').optional(),
});
  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request) => {
        ...
        return displayService.getDefaultCourses(pathway);
      },
    },
  },
  {
    ...
    options: {
      ...
      handler: async (request) => {
        const { pathwayService, displayService } = request.services();
        const { pathwayId } = request.params;
        const pathwayCourses = await pathwayService.findCoursesByPathwayId(pathwayId);
        return { courses: await displayService.pathwayCourses(pathwayCourses) };
      },
    },
  },
  {
    ...
    options: {
      ...
      handler: async (request) => {
        ...
        const courses = await pathwayService.findCoursesByPathwayId(pathwayId);
        return { courses: await displayService.pathwayCourses(courses) };
      },
    },
  },
];
