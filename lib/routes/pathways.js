...
module.exports = [
  {
    ...
    options: {
      ...
      handler: async (request, h) => {
        ...
        let pathway = await displayService.pathway(pathways, request.query.courseType);
  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request, h) => {
        ...
        return { pathway: await displayService.pathway(pathway, request.query.courseType) };
      },
    },
  },
  {
