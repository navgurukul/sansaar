    ...
    options: {
      ...
      validate: {
        headers: Joi.object({
          ...
          course_type: Joi.string().valid('markdown', 'json').allow(null).optional(),
        }),
      ...
      handler: async (request, h) => {
        ...
        let pathway = await displayService.pathway(pathways, request.headers.course_type);
  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request, h) => {
        ...
        return { pathway: await displayService.pathway(pathway, request.headers.course_type) };
      },
    },
  },
  {
