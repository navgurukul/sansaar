    ...
    options: {
      ...
      validate: {
        headers: Joi.object({
          ...
          'course-type': Joi.string().valid('markdown', 'json').allow(null).optional(),
        }),
      ...
      handler: async (request, h) => {
        ...
        let pathway = await displayService.pathway(pathways, request.headers['course-type']);
        ...
        if (request.headers.platform !== 'web') {
          pathway = _.filter(pathway, (e) => e.code !== 'JVSCPT');
        }
  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request, h) => {
        ...
        return { pathway: await displayService.pathway(pathway, request.headers['course-type']) };
      },
    },
  },
  {
