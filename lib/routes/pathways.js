  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request, h) => {
        ...
        return { courses: request.payload };

        // const upsertCourses = await pathwayService.upsertPathwayCourses(pathwayId, courseIds);
        // // const upsertCourses = async (txn) => {
        // //   return pathwayService.upsertPathwayCourses(pathwayId, courseIds, txn);
        // // };
        // // await h.context.transaction(upsertCourses);
        // return { courses: await pathwayService.findCoursesByPathwayId(pathwayId) };
      },
    },
  },
];
